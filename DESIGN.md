...
- **Absolute Path Clients**: Antigravity (`.agents/plugins/unity-lean-mcp/mcp_config.json`) and Cursor (`.cursor/mcp.json`) do not support workspace root variable expansion in MCP configurations and require absolute paths for `cwd`.
